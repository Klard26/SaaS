...
**Why:** these are spread across many schema files; it's easy to miss `assessments`, `offer_acceptances`, and the two `gebaeudecheck_*` tables. When adding any new table keyed by user/clerk id, add it to the account-deletion transaction too.
